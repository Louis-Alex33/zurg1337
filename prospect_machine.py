...
def parse_max_pages(value: str) -> int:
    ...
    if cleaned in {"all", "none", "0"}:
        return 0
    parsed = int(cleaned)
    if parsed < 0:
        raise argparse.ArgumentTypeError("--max-pages must be a positive integer or 'all'")
    return parsed
...
def build_parser() -> argparse.ArgumentParser:
    ...
    audit_parser.add_argument("--url", dest="url", help="Alias for --site")
    ...
    audit_parser.add_argument("--max-pages", type=parse_max_pages, help="Maximum pages per site, or 'all'")
    ...
    audit_parser.add_argument("--concurrency", type=int, default=5, help="Concurrent crawl requests")
