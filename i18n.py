...
EN_FALLBACKS: dict[str, str] = {
    ...
    "Rapport d’opportunités SEO GSC": "GSC SEO Opportunity Report",
    ...
    "Analyse de la période actuelle": "Current period analysis",
    "Comparaison entre deux périodes": "Two-period comparison",
    ...
    "À lire en 30 secondes pour décider quoi lancer en premier.": "Read in 30 seconds to decide what to launch first.",
    "Action recommandée": "Recommended action",
    "Pages concernées": "Affected pages",
    "Pourquoi maintenant": "Why now",
    "Traiter les pages à plus fort potentiel": "Tackle the highest-potential pages",
    "Réécrire les résultats Google sous-cliqués": "Rewrite under-clicked Google results",
    "Exploiter les requêtes utiles": "Use useful queries",
    "Valider les arbitrages avant production": "Validate decisions before production",
    "Potentiel théorique prioritaire": "Priority theoretical potential",
    "Taux de clic à améliorer": "Click-through rate to improve",
    "Intentions mieux couvertes": "Better covered intents",
    "Moins d'actions inutiles": "Fewer unnecessary actions",
    "Elles concentrent les signaux visibilité, position et valeur business.": "They concentrate visibility, position, and business-value signals.",
    "Ces pages sont déjà affichées dans Google.": "These pages already appear in Google.",
    "Les requêtes GSC montrent les angles réellement demandés.": "GSC queries show the angles people actually search for.",
    "Le rapport priorise GSC, sans remplacer un crawl technique.": "The report prioritizes GSC signals without replacing a technical crawl.",
    ...
    "Opportunités business": "Business opportunities",
    "Pages à forte valeur business : équipement, comparatifs, tests, affiliation, prospects ou produits numériques.": "High business value pages: equipment, comparisons, reviews, affiliates, prospects, or digital products.",
    ...
    "Gain de trafic estimé :": "Estimated traffic gain:",
    "Potentiel théorique détecté": "Detected theoretical potential",
    "Potentiel théorique détecté :": "Detected theoretical potential:",
    "selon comparaison CTR à position équivalente": "based on CTR comparison at equivalent position",
    "Voir note": "See note",
    ...
    "Aucune page à forte valeur business ne ressort clairement dans cet export.": "No clear high business value page stands out in this export.",
    ...
    "Ce rapport est basé sur les exports Google Search Console fournis. Il identifie les opportunités SEO visibles dans GSC, mais ne remplace pas un audit technique crawl complet.": "This report is based on the provided Google Search Console exports. It identifies SEO opportunities visible in GSC, but does not replace a full technical crawl audit.",
    ...
    "Rapport d'opportunités GSC": "GSC opportunities report",
    ...
    "Analyse de la période actuelle: aucun export précédent fourni, ce rapport identifie des opportunités sur la visibilité actuelle.": "Current period analysis: no previous export provided, this report identifies opportunities in current visibility.",
    "Comparaison entre deux périodes: export précédent fourni, les variations peuvent être contextualisées.": "Two-period comparison: previous export provided, changes can be contextualized.",
    "Le potentiel théorique détecté est un ordre de grandeur, pas une promesse. À confirmer après mise en ligne et suivi dans Google Search Console.": "The detected theoretical potential is an order of magnitude, not a promise. Confirm after publication and Google Search Console monitoring.",
    ...
    "Le potentiel théorique détecté est un ordre de grandeur, pas une promesse de trafic.": "The detected theoretical potential is an order of magnitude, not a traffic promise.",
    ...
    "La comparaison entre deux périodes dépend strictement des deux exports fournis et de leurs périodes.": "The two-period comparison depends strictly on the two provided exports and their periods.",
