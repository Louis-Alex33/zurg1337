...
class GSCAnalysisTests(unittest.TestCase):
    ...
    def test_run_gsc_analysis_writes_language_toggle_and_alternate_html(self) -> None:
        ...
        self.assertIn("Query opportunities", english_report)
        self.assertIn("Improve Google results", english_report)
        self.assertNotIn("Synthèse exécutive", english_report)
        self.assertNotIn("Les 3 priorités du mois", english_report)
        self.assertNotIn("Requêtes", english_report)
        self.assertNotIn("Querys", english_report)
