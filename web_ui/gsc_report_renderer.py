...
"""
    ...
    <section class="page">
      ...
      <div class="lectures"><div class="col"><h4>Ce que ce rapport dit</h4><ul><li><span>Le <b>potentiel théorique</b> est un ordre de grandeur, pas une promesse.</span></li><li><span>Les <b>positions</b> sont des moyennes GSC.</span></li><li><span>Les actions doivent être validées après mise en ligne.</span></li></ul></div><div class="col"><h4>Ce que le rapport ne dit pas</h4><ul><li><span>Il ne remplace pas un audit technique complet.</span></li><li><span>Les signaux de cannibalisation nécessitent une validation manuelle.</span></li><li><span>Sans export précédent, il ne diagnostique pas une baisse.</span></li></ul></div></div>
